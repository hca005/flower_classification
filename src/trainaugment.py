...
def main():
    ...
    ap.add_argument("--data_dir", type=str, default="data")  # data/train, data/val
    ...
    train_tf, eval_tf = get_transforms(img_size=args.img_size, augment=True)  # ✅ AUG HERE
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print(f"[AUG] epoch {epoch}/{args.epochs} | "
